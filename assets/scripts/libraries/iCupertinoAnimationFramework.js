...
class PageSlider {
    ...
    #events = {
        ...
        pointerUp: (x, y) => {
            ...
            let scrolTo = this.#events.scrollTo
            ...
            if( this.swipeIndicator.angle < 45 ){
                ...
                function render() {
                    ...
                    scrolTo(scrolle + springe - sprin.options.initial_position)
    
                    if (target.animationplay) requestAnimationFrame(render)
    ...
    constructor(el) {
        if (el["icaf-slider-active"] == undefined) {
            ...
            this.scrolTo = this.#events.scrollTo
